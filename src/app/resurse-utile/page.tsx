    ...
    <SimplePageLayout>
      <div className="flex flex-col items-ceneter gap-8">
        ...
        <div className="text-center [text-wrap:balance]">
          Pe această pagină am adunat mai multe resurse digitale gratuite care
          s&#8288;-&#8288;ar putea să îți fie utile. Dacă cunoști și alte
          resurse gratuite care ar putea fi utile pentru elevii care se
      ...
      >
        <span className="font-bold">Florentina Pavăl</span> (sau, așa cum este
        cunoscută online, <i>Profa de Mate</i>) are peste 400 de lecții video pe
        canalul său de YouTube. Este de asemenea foarte populară pe TikTok și
        Instagram. Ea este și creatoare a unui board game educațional numit{" "}
        <i>TikaMath</i>.
      </Resource>
      ...
      >
        ...
        cunoscute. Claudia are o experiență de peste 20 de ani în învățământ și
        încearcă să împartășească și altora din experiența sa didactică.
      </Resource>
      ...
      >
        <span className="font-bold">Corina Țurcanu</span> a creat și postat pe
        YouTube și pe blogul său peste 100 de lecții video de matematică:
        ...
        matematica, articole cu teorie, exerciții rezolvate pas cu pas și modele
        de teste cu rezolvări.
      </Resource>
      ...
      >
        <span className="font-bold">Matematică de Zece</span> este un canal de
        YouTube cu peste 600 de lecții video, majoritatea fiind dedicate
        pregătirii pentru Evaluarea Națională. Creatorul canalului, Sorin, își
        propune să explice matematica pe înțelesul tuturor.
      </Resource>
      ...
      >
        ...
        YouTube cu peste 100 de lecții de matematică scurte (cel mult 5 minute
        fiecare). Este acoperită materia din ciclul gimnazial (clasele V-VIII).
        În plus, sunt explicate subiecte din cadrul examenelor de Evaluare
        Naționala.
      </Resource>
      ...
      >
        ...
        resurse educaționale, inclusiv serialul <i>Mate cu Digitaliada</i> care
        te ajută să înțelegi mai bine matematica de gimnaziu și să te pregătești
        pentru Evaluarea Națională. Clarisa și Adrian, cei doi mentori, îți vor
        arăta în 10 episoade cum să rezolvi pas cu pas peste 100 de exerciții de
        algebră și geometrie, trecând prin toate cele trei tipuri de subiecte de
        la examen.
      </Resource>
      ...
      >
        <span className="font-bold">Cristina Tunegaru</span> îți propune să vă
        pregătiți împreună pentru Evaluarea Națională la Limba Română. Pe
      ...
      >
        <span className="font-bold">Succes la Examen</span> este un portal de
        pregătire pentru examene de admitere, inclusiv pentru Evaluarea
        Națională. Pe canalul lor de YouTube găsiți numeroase lecții video
        gratuite dedicate pregătirii pentru Evaluare Națională, atât la Limba și
        Literatura Română cu profesoara Alina Nicola, cât și la Matematică cu
        profesoara Ofelia Constantin.
      </Resource>
      ...
      >
        ...
        <i>„glasul românilor”</i> în latină) este un proiect care își propune să
        ajute cât mai mulți elevi din România cu examenele naționale: Evaluarea
        Națională și Bacalaureatul. Proiectul dispune de un canal de YouTube
        unde se încarcă frecvent materiale utile, dar și de o pagină web unde
        puteți găsi articole bine documentate, materiale teoretice, teste grilă
        și altele.
      </Resource>
      ...
      >
        <span className="font-bold">EduPedu.ro</span> este o publicație online
        care găzduiește exclusiv articole din domeniul educației și cercetării.
        Urmărim constant cum sunt educați copiii noștri, cine și cum face
        politicile din educație și cercetare, cine și cum îi formează pe
        profesori, cât de adecvate la lumea în care trăim sunt sistemele de
      ...
      >
        ...
        puteți găsi statistici despre sistemul educațional românesc bazate pe
        rezultatele la examenele naționale. Aici puteți găsi topuri ale liceelor
        și școlilor din România, precum și informații detaliate despre fiecare
        liceu și școală în parte.
      </Resource>
    </SimplePageLayout>
  );
}
